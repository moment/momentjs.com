...
Given how many projects depend on it, _we choose to prioritize stability over new features_.

As an example, consider that Moment objects are _mutable_. This is a common source of complaints about Moment.
