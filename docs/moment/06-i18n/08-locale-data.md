...
signature: |
  ...
  localeData.weekdays()
  localeData.weekdays(Boolean)      ## Added 2.23.0, sorts weekdays by locale
  localeData.weekdaysShort(Moment)
  localeData.weekdaysShort()
  localeData.weekdaysShort(Boolean) ## Added 2.23.0, sorts weekdays by locale
  localeData.weekdaysMin(Moment)
  localeData.weekdaysMin()
  localeData.weekdaysMin(Boolean)   ## Added 2.23.0, sorts weekdays by locale
